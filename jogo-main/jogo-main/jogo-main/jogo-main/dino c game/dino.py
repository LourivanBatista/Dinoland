...
while True:
    ...
    if cogumelo.rect.topright[0] <= 0 or cometa.rect.topright[0] <= 0:
        escolha_obstaculo = choice([0,1])
        cogumelo.rect.x = largura
        cometa.rect.x = largura
        cogumelo.escolha = escolha_obstaculo
        cometa.escolha = escolha_obstaculo
